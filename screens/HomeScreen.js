...
const HomeScreen = ({ route }) => {
  ...
  const featuredJobs = [
    { title: 'Software Engineer', company: 'Facebook', location: 'Accra, Ghana', salary: '$180,000', type: 'featured', image: require('../assets/logo-facebook.png') },
    { title: 'Data Scientist', company: 'Google', location: 'Accra, Ghana', salary: '$160,000', type: 'featured', image: require('../assets/icons_google.png') },
    { title: 'UI/UX Designer', company: 'Apple', location: 'San Francisco, US', salary: '$150,000', type: 'featured', image: require('../assets/cib_apple.png') },
  ...
  const popularJobs = [
    { title: 'Jr Executive', company: 'Burger King', location: 'Los Angeles, US', salary: '$96,000/y', type: 'popular', image: require('../assets/burger-king-4 1.png') },
    { title: 'Product Manager', company: 'Beats', location: 'Florida, US', salary: '$84,000/y', type: 'popular', image: require('../assets/beats-logo.png') },
    { title: 'Product Manager', company: 'Facebook', location: 'Florida, US', salary: '$86,000/y', type: 'popular', image: require('../assets/logo-facebook.png') },
    ...
    { title: 'Marketing Specialist', company: 'Apple', location: 'San Francisco, US', salary: '$80,000/y', type: 'popular', image: require('../assets/cib_apple.png') },
